Dicty11::Application.routes.draw do
	...
	match '/registration' => 'home#registration', :as => :registration #DJM
	match '/excursion' => 'home#excursion', :as => :excursion #DJM
	match '/abstracts' => 'home#abstracts', :as => :abstracts #DJM
